  ...
  <script src="tema/vendor/datatables/jquery.dataTables.js"></script>
  <script src="tema/vendor/datatables/dataTables.bootstrap4.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="tema/js/sb-admin.min.js"></script>
